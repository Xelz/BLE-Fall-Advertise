...
//   pAdvertising->setMinInterval(16000); // Set min interval to 10 seconds
//   pAdvertising->setMaxInterval(16000); // Set max interval to
//   pAdvertising->start();
